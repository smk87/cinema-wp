...
class Aepro_ACF_Repeater extends Widget_Base {
    ...
    function generate_output($settings,$with_wrapper = true){
        ...
        <?php if($settings['layout_mode'] == 'carousel'){ ?>
            ...
            <?php $this->add_render_attribute('acf-repeater-wrapper', 'class', 'ae-swiper-wrapper'); ?>
            <?php $this->add_render_attribute('acf-repeater-item', 'class', 'ae-swiper-slide'); ?>
            <?php $this->add_render_attribute('acf-repeater-inner', 'class', 'ae-swiper-slide-wrapper'); ?>
    ...
    function setting_controls(){
        ...
        $repeater_fields = $helper->get_ae_acf_repeater_fields();
