                        ...
                        <?php
                            ...
                            if($post_items->have_posts()){
	                            ...
	                            while($post_items->have_posts()){
	                             ...
	                             /*   if(($alt_count == $settings['columns'] + 1) && $alt_flag == false){
	                                    $alt_flag = true;
	                                    $alt_count = 0;
                                    }
                                    if(($alt_count == $settings['columns'] + 1) && $alt_flag == true){
	                                    $alt_flag = false;
	                                    $alt_count = 0;
                                    }
*/
	...
	/*function get_template($seq, $settings, $alt_layout, $alt_flag){

		if($settings['layout_mode'] == 'smart-grid' && in_array($seq, $alt_layout)){
			$template = $settings['alt_template'];
		}elseif( $settings['layout_mode'] == 'checker-board' && $seq % 2 == 0 && !$alt_flag){
			$template = $settings['alt_template'];
		}elseif( $settings['layout_mode'] == 'checker-board' && $seq % 2 != 0 && $alt_flag){
			$template = $settings['alt_template'];
		}else{
